...
const Hero = () => {
  ...
  // Comandos del terminal con sus respuestas
  ...
  // Hook para la animación de typing fluida
  useEffect(() => {
    ...
    if (isTypingCommand) {
      ...
      if (currentCharIndex < responseText.length) {
        ...
        timeout = setTimeout(() => {
          ...
          if (nextIndex < terminalCommands.length) {
        ...
        {isDarkMode && (
          <div className={styles.commandLine}>
            <div className="text-left space-y-1 text-xs sm:text-sm lg:text-base">
              <div 
                className="text-emerald-400 whitespace-pre-line leading-relaxed min-h-[150px] sm:min-h-[180px]"
